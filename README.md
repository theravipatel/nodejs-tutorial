...
## 47) NodeJs/ExpressJs - Upload File API using Multer
...
## 49) Events module and Event Emitter object
...
## 51) MySQL with Node Js: MySQL package installation and Database Connection
...
## 52) MySQL with NodeJs/ExpressJs - Basic APIs - POST/PUT/GET/DELETE APIs
- Make a separate connection file and include it in all other file where required.
- mysql_connection.js
```
// Include MySQL package
...
## 53) MySQL with NodeJs - Create Database
...
## 54) MySQL with NodeJs - Create Table
...
## 55) PostgreSQL with Node Js: PostgreSQL package installation and Database Connection
...
## 56) PostgreSQL with NodeJs/ExpressJs - Basic APIs - POST/PUT/GET/DELETE APIs
- Make a separate connection file and include it in all other file where required.
...
## 57) JSON Web Token (JWT) Authentication using Node Js / Express Js
...
## 58) Passport Js Authentication using Node Js / Express Js
...
## 59) Argument Parsing with Yargs in Node Js
...
## 60) Storing Data with JSON in Node Js
...
## 61) ES6 Arrow Functions and 'this' Binding
...
## 63) Making HTTP Requests using Node JS library
...
## 64) Making HTTP Requests without using Node JS library
...
## 65) ES6 Object Property Shorthand and Destructuring
...
## 66) Avoiding Global Modules in Node Js
